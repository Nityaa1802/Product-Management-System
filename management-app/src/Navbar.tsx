    ...
    <>
      <nav className="bg-black md:h-16 h-12 w-full flex justify-between items-center md:px-12  p-4 mb-4">
        ...
        <div className="flex items-center overflow-hidden bg-black ">
          ...
          <NavLink className="md:px-3 md:py-1 p-1 px-2 text-white border-2 rounded-xl my-auto border-white md:tracking-wide  uppercase text-xs tracking-tight" to={user?'/logout':'/login'}>
            {user?'SignOut':'SignIn'}
          </NavLink>
        </div>
      </nav>
